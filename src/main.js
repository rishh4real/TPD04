...
const defaultMenuItems = [
  ...
  },
  {
    ...
    detail: 'Sick of cheese dunked burgers? Homemade mutton kebab tikkis in a ladi pav with tangy green chutney and a garlic hung curd dressing. Onion ring seasoned with mustard oil for that zing.',
    protein: '25-30 g',
    prices: ['500', '-', '-'],
  },
  {
  ...
  },
  {
    ...
    detail: 'Juicy boneless chicken tossed in a tangy peri peri marinade and cooked with bell peppers.',
    protein: '35-40 g',
  ...
  },
  {
    ...
    detail: 'Fresh, zingy salsa of tomatoes, peppers, herbs and spices. Bright, punchy and just spicy enough to keep things interesting.',
    protein: '35-40 g',
    prices: ['500', '1050', '2000'],
  },
  {
    ...
    detail: 'A little Mediterranean holiday from my kitchen. Boneless chicken tossed with olives, sun dried tomatoes, cherry tomatoes, garlic, herbs and a touch of spice.',
    protein: '35-40 g',
    prices: ['500', '1050', '2000'],
  },
  {
    ...
    detail: 'There are many ways to do this. We do it our way. Colourful veggies sauteed with soft chicken pieces. No cornflour. Just pure Umami.',
    protein: '35-40 g',
    prices: ['500', '1050', '2000'],
  },
  {
    ...
    detail: 'Minced chicken cooked with tomatoes, peppers, herbs and Mexican spices for a smoky, tangy, bowl of goodness. Eat it straight, scoop it up, stuff it into something - you decide.',
    protein: '35-40 g',
    prices: ['500', '950', '1800'],
  },
  {
    ...
    detail: 'Because the mutton sliders should not have all the fun. Homemade chicken tikkis tucked into soft ladi pav with tangy green chutney, garlicky hung-curd dressing and mustard-oil seasoned onion rings.',
    protein: '25-30 g',
    prices: ['500', '-', '-'],
  },
  {
  ...
  },
  {
    ...
    detail: 'Our biggest bestseller. A salad with actual substance. Nutty barley, crunchy roasted nuts, fresh veggies and salty feta, brought together with a bright, zesty sumac, honey, lime dressing. Lots of texture.',
    protein: '15-20 g*',
    prices: ['500', '950', '1800'],
  },
  {
    ...
    detail: 'Tangy, Citrusy, Fresh. Chickpeas, rajma and kala chana tossed with crunchy bell pepper bits, fresh herbs and a punchy Mediterranean-style dressing. Hearty, fresh and filling enough to be the meal.',
    protein: '15-20 g*',
    prices: ['400', '650', '1250'],
  },
  {
    ...
    detail: 'Paneer likes a little colour too. Soft paneer tossed with crunchy assorted peppers, garlic, herbs and just enough seasoning to let everything shine. You will ask us what we used to give it that flavour. No cornflour.',
    protein: '30-35 g',
    prices: ['500', '850', '1600'],
  },
  {
    ...
    detail: 'Step away from the chilli paneer. Soft paneer tossed with ginger, garlic, sesame and savoury Oriental flavours, without the sticky, gloopy sauce. No cornflour.',
    protein: '30-35 g',
    prices: ['500', '850', '1600'],
  },
  {
    ...
    detail: 'Soft cubes tossed with tomatoes, peppers, herbs and Mexican spices for a fresh, smoky and tangy kick. Desi protein, Mexican mood. No cornflour.',
    protein: '30-35 g',
    prices: ['500', '850', '1600'],
  },
  {
    section: 'veg',
    name: 'Olive Paneer',
    detail: 'Soft paneer tossed with olives, sun dried tomatoes, rocket, garlic, herbs and a little spice for a savoury Mediterranean-inspired spin.',
    protein: '30-35 g',
    prices: ['500', '850', '1600'],
  },
  {
    ...
    detail: 'Cooked with onions, tomatoes, garlic and proper desi masala till they soak up every bit of flavour.',
    protein: '40-45 g*',
    prices: ['400', '650', '1250'],
  },
  {
    ...
    detail: 'Tossed with crunchy veggies, ginger, garlic, sesame and savoury Oriental flavours. Colourful, punchy.',
    protein: '40-45 g*',
    prices: ['400', '650', '1250'],
  },
  {
    ...
    detail: 'Marinated with hung curd, Indian spices and a little chilli, then cooked till charred at the edges and soft inside. All the tikka feels.',
    protein: '25-30 g',
    prices: ['500', '950', '1800'],
  },
  {
  ...
  },
  {
    ...
    detail: 'Soft cubes tossed with tomatoes, peppers, herbs and Mexican spices for a fresh, smoky and tangy kick. Desi protein, Mexican mood.',
    protein: '25-30 g',
    prices: ['500', '950', '1800'],
  },
  {
    section: 'veg',
    name: 'Olive Tofu',
    detail: 'Soft Tofu tossed with olives, sun dried tomatoes, rocket, garlic, herbs and a little spice for a savoury Mediterranean-inspired spin.',
    protein: '25-30 g',
    prices: ['500', '950', '1800'],
  },
  {
    ...
    detail: '3 beans (cholley, rajma, kala chana), almond-walnut slivers and seeds come together with herbs and spices, shaped by hand and pan-seared till golden. Vegan.',
    protein: '20-25 g*',
    prices: ['500', '950', '1800'],
  },
  {
    ...
    detail: 'Pick your dal - hara moong, mixed or peeli - finished with a proper gharwala tadka and paired with two sattu-stuffed parathas. Simple, wholesome and deeply satisfying.',
    protein: '25-30 g*',
    prices: ['400', '650', '-'],
  },
  {
